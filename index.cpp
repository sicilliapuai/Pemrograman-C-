...
int Cari(List L){
	...
	cout<<"===================================== \n";
	inputUlang2:
	cout<<"Data Yg ingin diCari :";
 	cin>>x.kode_brg;
 	address p=NULL;
	 	p= Search (L, x);
	
	if(p==NULL) cout<<"Data Tidak Ditemukan";
 	else {
...
int main(){
	...
	int pilih;
 	...
 	data_awal[0]={001,"A02","Nike","Putih","Promos ampai akhir tahun",750000,10};
